...
<div class="modal-overlay fixed inset-0 bg-gray-800 bg-opacity-50 hidden" id="userModal">
    <div class="ModalColor rounded-lg w-full max-w-2xl p-6 shadow-lg max-h-[90vh] overflow-y-auto">
        ...
        <form method="POST" action="{{ route('create-account.store') }}" id="formUser">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-4">
                    <label for="regional" class="block mb-2 TextColor font-bold">Regional</label>
                ...
                <div class="mb-4">
                    <label for="primer_nombre" class="block mb-2 TextColor font-bold">Primer Nombre</label>
                ...
                <div class="mb-4">
                    <label for="segundo_nombre" class="block mb-2 TextColor font-bold">Segundo Nombre</label>
                ...
                <div class="mb-4">
                    <label for="primer_apellido" class="block mb-2 TextColor font-bold">Primer Apellido</label>
                ...
                <div class="mb-4">
                    <label for="segundo_apellido" class="block mb-2 TextColor font-bold">Segundo Apellido</label>
                ...
                <div class="mb-4">
                    <label for="documento_proveedor" class="block mb-2 TextColor font-bold">Documento Proveedor</label>
                ...
                <div class="mb-4">
                    <label for="correo_personal" class="block mb-2 TextColor font-bold">Correo Personal</label>
                ...
                <div class="mb-4">
                    <label for="numero_contrato" class="block mb-2 TextColor font-bold">Número de Contrato</label>
                ...
                <div class="mb-4">
                    <label for="fecha_inicio_contrato" class="block mb-2 TextColor font-bold">Fecha de Inicio del Contrato</label>
                ...
                <div class="mb-4">
                    <label for="fecha_terminacion_contrato" class="block mb-2 TextColor font-bold">Fecha de Terminación del Contrato</label>
                ...
                <div class="mb-4">
                    <label for="user_id" class="block mb-2 TextColor font-bold">Rol Asignado </label>
