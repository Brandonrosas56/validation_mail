<!-- Modal -->
<div id="activationModal" class="modal-overlay fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 hidden z-50">
        ...
        <form method="POST" action="{{ route('activation.store') }}" id="formActivation">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 overflow-y-auto">
                ...
                <div>
                    ...
                    <input type="text" name="documento_proveedor" id="documento_proveedor" class="custom-border rounded-lg w-full p-2 bg-white focus:outline-none">
                </div>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="primer_apellido" id="primer_apellido" class="custom-border rounded-lg w-full p-2 bg-white focus:outline-none" required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="fecha_inicio_contrato" id="fecha_inicio_contrato" class="custom-border rounded-lg w-full p-2 bg-white focus:outline-none" required>
                </div>
